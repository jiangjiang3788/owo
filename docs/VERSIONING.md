...
| `0.3` | 长期记忆脑主线，对应 `v0.3.0` 起的 Memory Brain 文档 | `docs/0.3/README.md` | 兼容保留 |
| `0.4` | 历史大整理主线，对应 `v0.4.0` 起的大历史回填文档 | `docs/0.4/README.md` | 兼容保留 |
| `0.5` | 可信记忆主线，对应 `v0.5.0` 起的审查和纠错文档 | `docs/0.5/README.md` | 当前主线 |

## 命名规则

1. 0.2 功能收口继续查阅 `docs/0.2/`；长期记忆脑新版本使用 `v0.3.x`；历史大整理使用 `v0.4.x`；可信记忆使用 `v0.5.x`。
2. 新的 0.3 release 计划文档放到 `docs/0.3/release-v0.3.x-plan.md`；新的 0.5 计划放到 `docs/0.5/release-v0.5.x-plan.md`。
