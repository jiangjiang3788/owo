...
当前文档只保留 **0.1 / 0.2 / 0.3 / 根路径 gate 入口** 四类路径。
...
`0.3` 版本线已在 `v0.3.0` 正式开启。后续 0.3 记忆脑文档写入 `docs/0.3/`。

`V27`、`V37`、`V38` 这类编号是 0.1 历史 gate 编号，不再作为产品版本号继续追加。产品功能版本统一使用 `v0.2.x` / `v0.3.x`。
