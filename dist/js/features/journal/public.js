...
(function registerJournalPublicFacade(global) {
    ...
    function getRoutingReport() {
        return {
            ...
            aiExecutionOwner: 'OwoApp.features.journalRuntime.publicApi',
            outputContractOwner: 'OwoApp.core.output.outputContracts',
            promptOwner: 'js/modules/journal.js single-builder',
            writeOwner: 'js/modules/journal.js via journalService',
